...
//---------------------------------------HERE I USED STATIC VALUE---------------------------------------------//
    ...
    return (
        ...
        <div style={{ height: window.innerHeight - 135, width: '100vw', position: 'relative', overflow: 'hidden' }}>
            <canvas ref={canvasRef} style={{ height: window.innerHeight - 135, width: '100%' }} />
            <div
                onCopy={onCopy}
                onPaste={onPaste}
                onScroll={onScroll}
